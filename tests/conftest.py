...
def dados_tratados_exemplo() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        "data": pd.to_datetime([
            "2023-08-01", "2023-08-15", "2023-09-01", "2023-09-20",
            "2024-08-05", "2024-08-20", "2024-09-10", "2024-09-25",
        ...
        "estado": ["PARA"] * 10,
        "municipio": [
            "OBIDOS", "OBIDOS", "OBIDOS", "SANTAREM",
            "OBIDOS", "ALTAMIRA", "OBIDOS", "OBIDOS", "SANTAREM", "OBIDOS"
        ],
        "latitude": [-1.908, -1.910, -1.912, -2.443, -1.905, -3.203, -1.907, -1.909, -2.440, -1.915],
        "longitude": [-55.518, -55.520, -55.522, -54.708, -55.510, -52.206, -55.512, -55.515, -54.710, -55.518],
    })
